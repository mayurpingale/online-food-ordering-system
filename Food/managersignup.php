<html>
  ...
  <head>
    <title> Manager Signup | QuickEats </title>
  </head>
  ...
  <body>
    ...
    <div class="container">
    <div class="jumbotron">
     <h1 style="font-family: 'Roboto Slab', serif">Hi Manager, <br> Welcome to <span style="text-shadow: 2px 2px 5px lightgray; color: black;"> QuickEats </span></h1>
     <br>
   <p style="font-family: 'Roboto Slab', serif">Get started by creating your account</p>
    </div>
    </div>
      ...
      <div class="panel panel-primary">
        ...
        <div class="row">
          <div class="form-group col-xs-12">
            ...
            <div class="input-group">
              <input data-validation="Number"  min="10" max="10" class="form-control" id="contact" type="Number" name="contact" placeholder="Contact" required="">
              <span class="input-group-btn">
