...
if(!empty($_SESSION["cart"]))
{
  ...
  <div class="container">
      <div class="jumbotron">
        <h1 style="font-family: 'Roboto Slab', serif">Your Shopping Cart</h1>
        <p style="font-family: 'Roboto Slab', serif">Looks tasty...!!!</p>
...
if(empty($_SESSION["cart"]))
{
  ...
  <div class="container">
      <div class="jumbotron">
        <h1 style="font-family: 'Roboto Slab', serif">Your Shopping Cart</h1>
        <p style="font-family: 'Roboto Slab', serif">Oops! We can't smell any food here. Go back and <a href="foodlist.php">order now.</a></p>
