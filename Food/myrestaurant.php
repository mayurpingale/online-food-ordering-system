...
header('Location: managerlogin.php.php'); // Redirecting To Home Page
}
...
<div class="container">
    ...
    <div class="col-xs-9">
      <div class="form-area" style="padding: 0px 100px 100px 100px;">
        ...
        <br style="clear: both">
          <h3 style="margin-bottom: 25px; text-align: center; font-size: 30px;font-family: 'Roboto Slab', serif"> MY RESTAURANT</h3>
