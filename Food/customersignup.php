<html>
<head>
    <title> Guest Signup | QuickEats </title>
  </head>
  ...
  <body>
    ...
    <div class="container">
    <div class="jumbotron">
     <h1 style="font-family: 'Roboto Slab', serif">Hi Guest, <br> Welcome to <span style="text-shadow: 2px 2px 5px lightgray; color: black;"> QuickEats </span></h1>
     <br>
