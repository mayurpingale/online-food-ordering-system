...
<html>
  ...
  <head>
    <title> Manager Login | QuickEats</title>
  </head>
...
<div class="container">
    <div class="jumbotron">
     <h1 style="font-family: 'Roboto Slab', serif">Hello Manager! </h1>
     <p style="font-family: 'Roboto Slab', serif">Manage all your restaurant from here</p>
...
<div class="col-xs-3">
  ...
  <div class="form-area" style="padding: 10px 10px 110px 10px; ">
    ...
    <div style="text-align: center;">
      <h3 style="font-family: 'Roboto Slab', serif">Click On Menu <br><br></h3>
    </div>
    <?php
...
<div class="col-md-6">
 <div class="form-area" style="padding: 0px 100px 100px 100px;">
        ...
        <br style="clear: both">
          <h3 style="margin-bottom: 25px; text-align: center; font-size: 30px; style="font-family: 'Bitter', serif"> EDIT YOUR FOOD ITEMS HERE </h3>
