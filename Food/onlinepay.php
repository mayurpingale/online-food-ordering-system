...
<html>
  ...
  <head>
    <title> Online Payment | QuickEats</title>
  </head>
...
<div class="container">
    <div class="row">
        <div class="jumbotron">
          <h1 style="font-family: 'Roboto Slab', serif"class="text-center">Online Payment</h1>
          <p style="font-family: 'Bitter', serif"class="text-center">Enter your payment details below.</p>
        </div>
    </div>
    <div class="row">
                    ...
                    <div class="panel-heading">
                        ...
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <h5 style="font-family: 'Fraunces', serif""class="text-muted"> Credit Card Number</h5>
                            </div>
                        ...
                        <div class="row ">
                            <div class="col-md-3 col-sm-3 col-xs-3">
                                <span style="font-family: 'Fraunces', serif""class="help-block text-muted small-font"> Expiry Month</span>
                                <input type="text" class="form-control" placeholder="MM" required="" />
                            </div>
                            <div class="col-md-3 col-sm-3 col-xs-3">
                                <span style="font-family: 'Fraunces', serif""class="help-block text-muted small-font">  Expiry Year</span>
