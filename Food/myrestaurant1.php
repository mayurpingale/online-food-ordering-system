...
if (!$success){
  ...
  <script type="text/javascript" src="js/bootstrap.min.js"></script>
	...
	<div class="jumbotron" style="text-align: center;">
		<h1 style="font-family: 'Roboto Slab', serif">You already have one restaurant.</h1>
		<p style="font-family: 'Bitter', serif">Go back to your <a href="view_food_items.php">Restaurant</a></p>
	</div>
</div>
